...
<html>
<head>
	<title>Alterar Usuarios:: <?php echo $logado?></title>
...
<body>
	...
	<div id="cont">
	<div id="coisa">
	<form method="post" action="alter_usuarios.php" id="form" name="form">
		Informe o ID do usuario que deseja alterar.<br />
		ID:  
		<input type="text" name="id_usu" />
