...
<body>
	...
	<div id="cont">
	<div id="coisa">
		<form method="post" action="rel_compra.php" id="form" name="form">
		...
		Cód. fornecedor: 
		<input type="text" value="00" name="id_for" /><br /><br />
		Cód. produto:
		<input type="text" value="00" name="id_pro" /><a href="pesc_produto.php" target="blank" alt="Pesquisar" class="botaoForm">P</a><br />
