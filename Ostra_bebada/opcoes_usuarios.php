...
<head>
	<title>User:: <?php echo $logado?></title>
...
<body>
	...
	<div id="cont">
		<div id="coisa">
			<form  id="form" name="form" method="post"  action="opc.php" >
				<h3>ALTERAR SENHA</h3> <br />
				Digite sua senha:
				<input type="password" name="s_atual" /><br /><br />
				Digite a nova senha:
				<input type="password" name="s_nova1" /><br /><br />
				Digite novamente:
				<input type="password" name="s_nova2" /><br /><br />
