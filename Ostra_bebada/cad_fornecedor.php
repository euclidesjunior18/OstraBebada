...
<html>
<head>
	<title>Cadastro Fornecedores:: <?php echo $logado?></title>
...
<body>
	...
	<div id="cont">
	<div id="coisa">
		<form method="post" action="cad_for.php" id="form" name="form">
			<h3>CADASTRO DE FORNECEDORES:</h3><br />
			Nome:
			...
			<input type="submit" value="Cadastrar" class="botaoForm" onmouseover="verfCadFornecedor();" />
