...
<head>
	<title>Cadastro Usuario:: <?php echo $logado?></title>
...
<body>
	...
	<div id="cont">	
		<div id="coisa">
			<form method="post" action="cad.php" id="form" name="form">
				<h3>CADASTRO DE USUARIOS</h3><br />
				Nome:
				<input type="text" name="nome" id="nome" /><br /><br />
				Senha:
				<input type="password" name="senha1" id="senha1" /><br /><br />
				Repita a Senha:
				<input type="password" name="senha2" id="senha" /><br /><br />	 
				Tipo de Usuário: 
				<select name="tipo_usu">
					<option value="user">Usuario padrão</option>
					<option value="supe">Administrador</option>
				</select><br /><br />
				<input type="submit" value="Cadastrar" class="botaoForm" onmouseover="verfCadUser();"/>
