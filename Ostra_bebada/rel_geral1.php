...
<body>
	...
	<div id="cont">
	<div id="coisa">
		<form method="post" action="rel_geral.php" id="form" name="form">
		<h3>Relatório geral. </h3>
		Informe a data em que deseja consultar.<br /><br />
		Data: dia
		<select name="diaC">
		...
		ano
		<input type="text" value="20<?php echo date(y)?>" name="anoC" /><br />
