...
<html>
<head>
	<title>Alterar Fornecedores:: <?php echo $logado?></title>
...
<body>
	...
	<div id="cont">
	<div id="coisa">
		<form method="post" action="alter_fornecedores.php" id="form" name="form">
		Informe o ID do fornecedor que deseja alterar.<br />
		</br><p align="center">ID:  
		<input type="text" name="id_for" />
		<input type="submit" value="ok" class="botaoForm" />
		<a href="princ.php" class="botaoForm">Voltar</a>
	</form></p>
	<div id="conttbl">
	<?php
		$result = mysql_query('select * from fornecedor'); 
