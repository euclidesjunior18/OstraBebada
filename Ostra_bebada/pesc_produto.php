...
<html>
<head>
	<title>Pesquisa De Produtos:: <?php echo $logado?></title>
...
<body>
	...
	<div id="coisa" >
		<form>
		<div id="Container"> <h1>Pesquisa de Produtos</h1> <hr/> 
        <h2>Pesquisar Produtos:</h2> 
        <div id="Pesquisar"> 
        Infome a descrição do produto: <input type="text" name="txtnome" id="txtnome"/> 
        <input type="button" name="btnPesquisar" value="Pesquisar" class="botaoForm" onclick="getProdutos();"/> 
        </div> <hr/> 
